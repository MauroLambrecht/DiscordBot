...
export const CLIENT_ID = process.env.BOT_CLIENT_ID ?? '1127674277290852353';
export const CLIENT_SECRET = process.env.BOT_CLIENT_SECRET ?? 'IopFKCRYp-237lucLWJY5aIwO9s6OAFX';
